...
@class ORNotifySwitch, ORMoviePlayerView, KAProgressLabel, ORFacebookPicker, ORTwitterPicker;

@interface ORPostCaptureView : GAITrackedViewController <UITextViewDelegate, UITableViewDataSource, UITableViewDelegate>

- (id)initWithVideo:(OREpicVideo*)video andPlaces:(NSArray*)places;

@property (strong, nonatomic) IBOutlet UIView *contentView;
@property (weak, nonatomic) IBOutlet KAProgressLabel *progressRing;
...
@property (weak, nonatomic) IBOutlet UIView *viewUploadParent;
@property (weak, nonatomic) IBOutlet UILabel *lblUploadProgress;
@property (weak, nonatomic) IBOutlet UILabel *lblTranscoding;
@property (weak, nonatomic) IBOutlet UIButton *btnForceUpload;
...
@property (weak, nonatomic) IBOutlet UIView *viewUploadComplete;
...
- (IBAction)btnForceUpload_TouchUpInside:(id)sender;
- (IBAction)btnFinish_TouchUpInside:(id)sender;
...
@property (nonatomic, assign) BOOL directChanged;

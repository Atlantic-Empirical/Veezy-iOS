...
@interface ORExpiredVideoUpsell () <UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning>

@end

@implementation ORExpiredVideoUpsell
...
- (void)viewDidLoad
{
	...
	self.screenName = @"ExpiredVideoUpsell";
	...
	[AppDelegate.mixpanel track:@"Upsell-Loaded" properties:@{@"location": @"ORExpiredVideoUpsell"}];
	[ORLoggingEngine logEvent:@"Upsell-Loaded" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
...
{
	[AppDelegate.mixpanel track:@"Upsell-Dismissed" properties:@{@"location": @"ORExpiredVideoUpsell"}];
	[ORLoggingEngine logEvent:@"Upsell-Dismissed" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
...
{
	[AppDelegate.mixpanel track:@"Upsell-1moPressed" properties:@{@"location": @"ORExpiredVideoUpsell"}];
	[ORLoggingEngine logEvent:@"Upsell-1moPressed" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
	...
	if ([[ORSubscriptionController sharedInstance] canMakePurchases]) {
		[[ORSubscriptionController sharedInstance] purchaseProduct:IAP_1MO completion:^(SKPaymentTransaction *transaction) {
			if (transaction.transactionState == SKPaymentTransactionStateFailed) {
				...
				[AppDelegate.mixpanel track:@"Upsell-1moFailed" properties:@{@"location": @"ORExpiredVideoUpsell", @"Error": transaction.error.localizedDescription}];
				[ORLoggingEngine logEvent:@"Upsell-1moFailed" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
				...
				[AppDelegate.mixpanel track:@"Upsell-1moConverted" properties:@{@"location": @"ORExpiredVideoUpsell"}];
				[ORLoggingEngine logEvent:@"Upsell-1moConverted" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
...
{
	[AppDelegate.mixpanel track:@"Upsell-1yrPressed" properties:@{@"location": @"ORExpiredVideoUpsell"}];
	[ORLoggingEngine logEvent:@"Upsell-1yrPressed" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
	...
	if ([[ORSubscriptionController sharedInstance] canMakePurchases]) {
		[[ORSubscriptionController sharedInstance] purchaseProduct:IAP_1YR completion:^(SKPaymentTransaction *transaction) {
			if (transaction.transactionState == SKPaymentTransactionStateFailed) {
				...
				[AppDelegate.mixpanel track:@"Upsell-1yrFailed" properties:@{@"location": @"ORExpiredVideoUpsell", @"Error": transaction.error.localizedDescription}];
				[ORLoggingEngine logEvent:@"Upsell-1yrFailed" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
				...
				[AppDelegate.mixpanel track:@"Upsell-1yrConverted" properties:@{@"location": @"ORExpiredVideoUpsell"}];
				[ORLoggingEngine logEvent:@"Upsell-1yrConverted" params:[@[@"ORExpiredVideoUpsell"] mutableCopy]];
